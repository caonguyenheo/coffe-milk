...
//              {
      for(;;)
      {
                  ...
                  yv[10] =   (xv[0] + xv[10]) + 10 * (xv[1] + xv[9]) + 45 * (xv[2] + xv[8])
                           ...
                           + ( -0.6580443135 * yv[0]) + ( 6.8557557493 * yv[1])
                           + ( -32.1476034180 * yv[2]) + ( 89.3469198000 * yv[3])
                           + (-162.9905208500 * yv[4]) + ( 203.9256041900 * yv[5])
                           + (-177.2160841400 * yv[6]) + ( 105.6241448100 * yv[7])
                           + (-41.3217917780 * yv[8]) + (  9.5816199478 * yv[9]);
                  data8 = yv[10];
                  ...
                  yv3[10] =   (xv3[0] + xv3[10]) + 10 * (xv3[1] + xv3[9]) + 45 * (xv3[2] + xv3[8])
                           ...
                           + ( -0.6580443135 * yv3[0]) + ( 6.8557557493  * yv3[1])
                           + ( -32.1476034180 * yv3[2]) + ( 89.3469198000 * yv3[3])
                           + (-162.9905208500 * yv3[4]) + ( 203.9256041900 * yv3[5])
                           + (-177.2160841400 * yv3[6]) + ( 105.6241448100 * yv3[7])
                           + (-41.3217917780 * yv3[8]) + (  9.5816199478 * yv3[9]);
                  data9 = yv3[10];
////              UART_PRINT("\r\nyv[10]:%d\r\n",yv[10]); // printf value
                  I2S0_W0_MSW_W = data6;
                  I2S0_W0_LSW_W = 0;
